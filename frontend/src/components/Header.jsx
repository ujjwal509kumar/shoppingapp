        ...
        <div className="flex items-center justify-center min-h-screen">
          ...
          <div className="relative bg-white p-8 rounded-lg shadow-xl max-w-md w-full">
            ...
            <div className="flex justify-center my-8">
              ...
              <button onClick={clearCart} className="flex mr-2 text-white bg-red-500 border-0 py-2 px-2 focus:outline-none hover:bg-red-600 rounded text-sm"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
