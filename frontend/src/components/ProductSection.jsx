            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3 ">
              <div>
                <img
                  ...
                  src="https://m.media-amazon.com/images/I/71ipyBXW0BL._AC_UF1000,1000_QL80_.jpg"
                  alt=""
                ></img>
              ...
              <div>
                <img
                  className="object-cover w-full rounded-lg h-96 "
                  src="https://www.bigbasket.com/media/uploads/p/l/40193197_3-doms-pencil-smart-kit.jpg"
                  alt=""
                ></img>
                <h2 className="mt-4 text-xl font-semibold text-gray-800 capitalize ">
                  Kids Stationaryies
              ...
              <div>
                <img
                  className="object-cover w-full rounded-lg h-96 "
                  src="https://m.media-amazon.com/images/I/61zvuAxZHVL._AC_UY1100_.jpg"
                  alt=""
                ></img>
                <h2 className="mt-4 text-xl font-semibold text-gray-800 capitalize ">
                  Kid's Clothes
